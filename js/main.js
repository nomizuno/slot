(function() {
  ...
  var words =
   ...
   'そもそも企業が資金を調達するには「借金をすること」、「発行した株式を買ってもらうこと」の主に2つの方法がある。株式を発行して資金調達をし、事業活動を行う会社を「株式会社」と呼ぶ。株式の売買ができる株式市場（証券取引所）の審査基準をクリアすると上場できる。上場の目的は資金調達だが、世間からの信用が高まるという点も大きい。信用があるところには人材もお金もあつまる。君に友達もいなければ、お金もないのはつまりそういうことです',
   ...
   '分散型台帳技術。だれが誰にどれくらいお金を渡したか、というような取引データをそのネットワークに参加する全ての人が共有し、お互いに管理するシステム。前の取引履歴を元に次の取引が行われるので不正を行うのは難しい。国や企業が中心となる従来の中央集権型のシステムを根本からひっくり返すポテンシャルを秘めている。',
  ...
  'ユークリッドが体系づけた幾何学。5つの公準と5つの公理から組み立てられる。公準1　任意の点から任意の点に直線を引くことができる。公準2　任意の線分を延長する事ができる。公準3　任意の点を中心に任意の半径の円を描くことができる。公準4　直角はすべて等しい。'
 ];
